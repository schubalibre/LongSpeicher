class LongSpeicher50 implements LongSpeicher {
   ...
   public boolean loesche(long n) {
	   ...
	   if(hier.k.lubr.k == EDK || hier.k.rubr.k == EDK){
		   if(hier.k.lubr.k != EDK){
			   hier = hier.k.lubr;
		   }else{
			   hier.k = new Knoten(new RefK(hier.k.lubr.k),new RefK(hier.k.rubr.k), hier.k.data);
		   }
	   }else{
   ...
   private String treeToString(RefK aR2) {
	   ...
	   return aR2.k.data + "\n" + treeToString(aR2.k.rubr) + treeToString(aR2.k.lubr);
   }
